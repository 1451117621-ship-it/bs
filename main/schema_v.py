...
@main_bp.route("/python9k351/cal/<tableName>/<columnName>", methods=['GET'])
def python9k351_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python9k351/file/download", methods=['GET'])
def python9k351_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python9k351/file/upload", methods=['POST'])
def python9k351_file_upload():
    '''
    '''
...
@main_bp.route("/python9k351/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python9k351_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python9k351/follow/<tableName>/<columnName>", methods=['GET'])
def python9k351_follow(tableName, columnName):
    '''
...
@main_bp.route("/python9k351/location", methods=['GET'])
def python9k351_location():
    '''
...
@main_bp.route("/python9k351/matchFace", methods=['GET'])
def python9k351_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python9k351/option/<tableName>/<columnName>", methods=['GET'])
def python9k351_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python9k351/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python9k351_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python9k351/sh/<tableName>", methods=['POST'])
def python9k351_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python9k351_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python9k351/upload/<fileName>", methods=['GET'])
def python9k351_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python9k351/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python9k351/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
