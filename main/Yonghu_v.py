...
# 注册接口
@main_bp.route("/python9k351/yonghu/register", methods=['POST'])
def python9k351_yonghu_register():
...
# 登录接口
@main_bp.route("/python9k351/yonghu/login", methods=['GET','POST'])
def python9k351_yonghu_login():
...
# 登出接口
@main_bp.route("/python9k351/yonghu/logout", methods=['POST'])
def python9k351_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python9k351/yonghu/resetPass", methods=['POST'])
def python9k351_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python9k351/yonghu/session", methods=['GET'])
def python9k351_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python9k351/yonghu/page", methods=['GET'])
def python9k351_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 分页接口（前端）
@main_bp.route("/python9k351/yonghu/list", methods=['GET'])
def python9k351_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python9k351/yonghu/save", methods=['POST'])
def python9k351_yonghu_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python9k351/yonghu/add", methods=['POST'])
def python9k351_yonghu_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python9k351/yonghu/thumbsup/<id_>", methods=['GET'])
def python9k351_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python9k351/yonghu/info/<id_>", methods=['GET'])
def python9k351_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python9k351/yonghu/detail/<id_>", methods=['GET'])
def python9k351_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python9k351/yonghu/update", methods=['POST'])
def python9k351_yonghu_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python9k351/yonghu/delete", methods=['POST'])
def python9k351_yonghu_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python9k351/yonghu/vote/<int:id_>", methods=['POST'])
def python9k351_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 批量审核
@main_bp.route("/python9k351/yonghu/shBatch", methods=['POST'])
def python9k351_yonghu_shBatch():
    '''
    '''
...
# 分组统计接口
@main_bp.route("/python9k351/yonghu/group/<columnName>", methods=['GET'])
def python9k351_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        msg['data'] = yonghu.groupbycolumnname(yonghu,yonghu,columnName)
        return jsonify(msg)

# 按值统计接口
@main_bp.route("/python9k351/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python9k351_yonghu_value(xColumnName, yColumnName):
...
# 按日期统计接口
@main_bp.route("/python9k351/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python9k351_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
        ...
        return jsonify(msg)
# 按值统计（多）
@main_bp.route("/python9k351/yonghu/valueMul/<xColumnName>", methods=['GET'])
def python9k351_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python9k351/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python9k351_yonghu_valueMul_time(xColumnName):
...
# 总数量
@main_bp.route("/python9k351/yonghu/count", methods=['GET'])
def python9k351_yonghu_count():
    '''
    '''
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python9k351/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def python9k351_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python9k351/yonghu/lists", methods=['GET'])
def python9k351_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
        ...
        return jsonify(msg)
# 排序接口
@main_bp.route("/python9k351/yonghu/autoSort", methods=['GET'])
def python9k351_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 推荐算法接口
@main_bp.route("/python9k351/yonghu/autoSort2", methods=['GET'])
def python9k351_yonghu_autoSort2():
    if request.method == 'GET':
        ...
        L = []
        sql ="select * from yonghu where  in ('%s"%("','").join(leixing)+"') union all select * from yonghu where  not in('%s"%("','").join(leixing)+"')"
        data = db.session.execute(sql)
